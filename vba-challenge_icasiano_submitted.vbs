...
Sub stock()
    ...
    For i = 2 To lastrow1
            ...
            'To add color fill based on +/- change
    ...
    'To declare the last row for the second table
    lastrow2 = ws.Cells(Rows.Count, 9).End(xlUp).Row
  
            'Set/Reset greatest increase/decrease volume and greatest stock values
            Greatestinc = 0
            Greatestdec = 0
            greatestvol = 0
        ...
        For i = 2 To lastrow2
            ...
            'Retrieve the greatest increase value
            ...
            'Retrieve the greatest decrease value
            ...
            'To print the greatest increase/decrease volume and greatest stock values
            ws.Range("O2").Value = tickerGI
            ws.Range("O3").Value = tickerGD
            ws.Range("O4").Value = tickerGT
            ws.Range("P2").Value = Greatestinc * 100 & "%"
            ws.Range("P3").Value = Greatestdec * 100 & "%"
            ws.Range("P4").Value = greatestvol
            
            
     Next i
            ws.Range("A1:P" & lastrow1).Columns.AutoFit
    Next ws
